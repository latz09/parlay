...
const NewDiscussionForm = ({ setIsNewDiscussionOpen, userId, triggerQId, category }) => {
	...
	return (
		<form onSubmit={submitNewDiscussion}>
			<div className='m-8 grid gap-2'>
				<div className='grid gap-2 '>
					...
					>
						...
						<span className='text-sm opacity-80'>Think of it as title</span>
					</label>
					<input
						type='text'
						id='topic'
						required
						ref={topicInputRef}
						className='bg-dark/30 p-2 text-triary'
					/>
				</div>
				...
				<div className='grid gap-2'>
					...
					>
						...
						<span className='text-sm opacity-80'>*Max Characters: 300</span>
					</label>
					<textarea
						type='text'
						rows='5'
